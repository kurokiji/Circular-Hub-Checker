...
struct ItemsMock {
    ...
    static var itemDetail = ItemDetail(id: 23, unitID: "2656565", countryCode: "ES", langCode: "ES", title: "SADIS", description: "ninguna", price: 23, images: [], state: .published, tagID: "23", articles: [], uploads: [], benefits: nil, benefitSummary: nil, designers: nil, goodToKnows: nil, materials: nil, careInstructions: nil)
}
